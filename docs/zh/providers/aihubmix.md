...
进入 BulinBot 管理面板，点击左栏 **服务提供商 → 新增提供商 → OpenAI**。
...
![在 BulinBot 中配置](https://github.com/user-attachments/assets/ee2fb8ba-652c-4e97-a781-42a9082ad7eb)
...
AIHubMix 同时支持以下能力，均可在 BulinBot 中配置：
