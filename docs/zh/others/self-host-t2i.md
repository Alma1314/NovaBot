...
NovaBot 使用 [Alma1314/nova-bot-t2i-service](https://github.com/Alma1314/nova-bot-t2i-service) 项目作为默认的文本转图像服务。默认使用的文转图服务接口是
...
> [!TIP]
> 欢迎通过 [爱发电](https://afdian.com/a/nova-bot_team) 支持我们，以帮助我们支付服务器费用。
...
>如果你是使用本文档的 Docker教程 部署的 NovaBot ，url应为  `http://文转图服务容器名:8999`。

>如果部署在与 NovaBot 相同的机器上，url 应为 `http://localhost:8999`。
