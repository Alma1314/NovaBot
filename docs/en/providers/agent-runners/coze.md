...
![Create API Key](https://files.bulinbot.app/docs/source/images/coze/image_1.png)
...
![Create Token](https://files.bulinbot.app/docs/source/images/coze/image_2.png)

After that, we will get a new API Key. Please copy and save it, as it will be needed later.

![New API Key](https://files.bulinbot.app/docs/source/images/coze/image_3.png)
...
![Create Project](https://files.bulinbot.app/docs/source/images/coze/image_4.png)

![Create Project](https://files.bulinbot.app/docs/source/images/coze/image_5.png)
...
![Publish Agent](https://files.bulinbot.app/docs/source/images/coze/image_6.png)
...
![Agent Development](https://files.bulinbot.app/docs/source/images/coze/image_7.png)
