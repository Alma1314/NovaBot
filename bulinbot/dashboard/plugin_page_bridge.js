(function attachBulinBotPluginPageBridge() {
  const CHANNEL = "bulinbot-plugin-page";
  ...
  function notifyContextHandlers() {
    contextHandlers.forEach((handler) => {
      try {
        ...
        console.error("BulinBotPluginPage context handler failed:", error);
      }
    });
  }
