...
from bulinbot.core import DEMO_MODE
...
DASHBOARD_JWT_COOKIE_NAME = "bulinbot_dashboard_jwt"
DASHBOARD_JWT_COOKIE_MAX_AGE = 7 * 24 * 60 * 60
SKIP_DEFAULT_PASSWORD_AUTH_ENV = "BULINBOT_DASHBOARD_SKIP_DEFAULT_PASSWORD_AUTH"
SKIP_DEFAULT_PASSWORD_AUTH_ENV_LEGACY = "DASHBOARD_SKIP_DEFAULT_PASSWORD_AUTH"
LOCAL_DASHBOARD_HOSTS = {"127.0.0.1", "localhost", "::1"}
DEFAULT_PASSWORD_LOGIN_FAILURE_MESSAGE = (
    "Login failed. If this is your first time using BulinBot, the old default "
    "bulinbot password has been replaced by a random strong password printed in "
    "the startup logs. Check the initial password in the logs and try again. "
    "Learn more: https://docs.bulinbot.app/en/faq.html\n\n"
    "登录失败。如果您是初次使用，旧版默认 bulinbot 密码已改为启动日志中输出的"
...
LEGACY_PASSWORD_LOGIN_FAILURE_MESSAGE = (
    ...
    "BulinBot even though the password is correct, see "
    "https://docs.bulinbot.app/en/faq.html\n\n"
    "用户名或密码错误。如果你在升级 BulinBot 后遇到了密码正确但无法登录的情况，"
    "请参考 https://docs.bulinbot.app/faq.html"
)
...
class AuthRoute(Route):
    ...
    async def _is_setup_required(self) -> bool:
        ...
        return dashboard_config.get(
            "username"
        ) == "bulinbot" and is_default_dashboard_password(
