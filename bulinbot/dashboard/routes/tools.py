...
from bulinbot.core.agent.mcp_client import MCPTool, validate_mcp_stdio_config
from bulinbot.core.core_lifecycle import BulinBotCoreLifecycle
from bulinbot.core.star import star_map
from bulinbot.core.tools.registry import get_builtin_tool_config_statuses
...
class ToolsRoute(Route):
    ...
    async def get_tool_list(self):
        ...
        try:
            ...
            config_entries = []
            for conf_id, conf in self.core_lifecycle.bulinbot_config_mgr.confs.items():
