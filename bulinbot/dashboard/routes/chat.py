...
from bulinbot.core.agent.message import get_checkpoint_id, is_checkpoint_message
...
from bulinbot.core.platform.sources.webchat.message_parts_helper import (
    build_webchat_message_parts,
    create_attachment_part_from_existing_file,
    strip_message_parts_path_fields,
    webchat_message_parts_have_content,
)
from bulinbot.core.platform.sources.webchat.webchat_queue_mgr import webchat_queue_mgr
from bulinbot.core.utils.active_event_registry import active_event_registry
...
class ChatRoute(Route):
    def __init__(
        ...
        self.attachments_dir = os.path.join(get_bulinbot_data_path(), "attachments")
        self.legacy_img_dir = os.path.join(get_bulinbot_data_path(), "webchat", "imgs")
