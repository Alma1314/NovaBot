...
from bulinbot.core.backup.importer import BulinBotImporter
...
class BackupRoute(Route):
    ...
    def __init__(
        ...
        self.backup_dir = get_bulinbot_backups_path()
        self.data_dir = get_bulinbot_data_path()
        ...
        try:
            with zipfile.ZipFile(zip_path, "r") as zf:
                if "manifest.json" in zf.namelist():
                    ...
                    # 没有 manifest.json，不是有效的 BulinBot 备份
                    return None
        except Exception as e:
    ...
    async def list_backups(self):
        ...
        try:
            ...
            for filename in os.listdir(self.backup_dir):
                ...
                # 如果返回 None，说明不是有效的 BulinBot 备份，跳过
                ...
                backup_files.append(
                    {
                        ...
                        "bulinbot_version": manifest.get("bulinbot_version", "未知"),
