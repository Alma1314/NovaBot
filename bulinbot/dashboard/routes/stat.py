...
from bulinbot.core import DEMO_MODE, logger
from bulinbot.core.config import VERSION
from bulinbot.core.core_lifecycle import BulinBotCoreLifecycle
from bulinbot.core.db import BaseDatabase
from bulinbot.core.db.migration.helper import check_migration_needed_v4
...
from bulinbot.core.utils.io import get_dashboard_version
...
class StatRoute(Route):
    ...
    async def is_default_cred(self):
        ...
        return (
            username == "bulinbot" and is_default_dashboard_password(password)
        ) and not DEMO_MODE
    ...
    async def test_ghproxy_connection(self):
        ...
        try:
            ...
            test_url = f"{proxy_url}/https://github.com/BulinBotDevs/BulinBot/raw/refs/heads/master/.python-version"
    ...
    async def get_changelog(self):
        ...
        try:
            ...
            project_path = get_bulinbot_path()
    ...
    async def get_first_notice(self):
        try:
            ...
            base_path = Path(get_bulinbot_path())
