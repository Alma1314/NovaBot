...
def _set_dashboard_flag(config: BulinBotConfig, key: str, value: bool) -> None:
...
def _has_usable_pbkdf2_password(config: BulinBotConfig) -> bool:
...
def get_dashboard_password_hash(config: BulinBotConfig, *, upgraded: bool) -> str:
...
def set_dashboard_password_hashes(config: BulinBotConfig, raw_password: str) -> None:
