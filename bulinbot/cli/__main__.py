...
@click.group()
@click.version_option(__version__, prog_name="BulinBot")
def cli() -> None:
    """The BulinBot CLI"""
    click.echo(logo_tmpl)
    click.echo("Welcome to BulinBot CLI!")
    click.echo(f"BulinBot CLI version: {__version__}")
