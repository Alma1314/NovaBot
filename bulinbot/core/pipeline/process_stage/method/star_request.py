"""本地 Agent 模式的 BulinBot 插件调用 Stage"""
...
from bulinbot.core.star.star_handler import EventType, StarHandlerMetadata
...
class StarRequestSubStage(Stage):
    async def initialize(self, ctx: PipelineContext) -> None:
        self.prompt_prefix = ctx.bulinbot_config["provider_settings"]["prompt_prefix"]
        self.identifier = ctx.bulinbot_config["provider_settings"]["identifier"]
        self.ctx = ctx
