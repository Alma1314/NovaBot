...
from bulinbot.core import db_helper, logger
...
from bulinbot.core.utils.session_lock import session_lock_manager
...
class InternalAgentSubStage(Stage):
    ...
    async def _send_llm_error_message(
        self, event: BulinMessageEvent, message: object
    ) -> None:
...
# we prevent bulinbot from connecting to known malicious hosts
