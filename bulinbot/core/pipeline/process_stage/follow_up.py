...
from bulinbot.core.agent.runners.tool_loop_agent_runner import FollowUpTicket
...
def _event_follow_up_text(event: BulinMessageEvent) -> str:
...
def try_capture_follow_up(event: BulinMessageEvent) -> FollowUpCapture | None:
