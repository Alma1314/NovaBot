...
from bulinbot.core.platform.sources.webchat.webchat_event import WebChatMessageEvent
from bulinbot.core.platform.sources.wecom_ai_bot.wecomai_event import (
...
class PipelineScheduler:
    ...
    async def _process_stages(self, event: BulinMessageEvent, from_stage=0) -> None:
        """依次执行各个阶段
    ...
    async def execute(self, event: BulinMessageEvent) -> None:
        """执行 pipeline
