...
from bulinbot.core.utils.bulinbot_path import get_bulinbot_knowledge_base_path

if TYPE_CHECKING:
    from bulinbot.core.db.vec_db.faiss_impl import FaissVecDB
...
class KBSQLiteDatabase:
    def __init__(self, db_path: str | None = None) -> None:
        ...
        Args:
            db_path: 数据库文件路径, 默认位于 BulinBot 数据目录下的 knowledge_base/kb.db

        """
        if db_path is None:
            db_path = str(Path(get_bulinbot_knowledge_base_path()) / "kb.db")
