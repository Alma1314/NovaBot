...
def build_skills_prompt(skills: list[SkillInfo]) -> str:
    ...
    return (
        ...
        "(one short line). Prefer `bulinbot_*` tools when running skill "
        "scripts.\n"
...
class SkillManager:
    def __init__(
        ...
        self.skills_root = skills_root or get_bulinbot_skills_path()
        self.plugins_root = plugins_root or get_bulinbot_plugin_path()
        data_path = Path(get_bulinbot_data_path())
    ...
    def install_skill_from_zip(
        ...
        *,
        ...
        with zipfile.ZipFile(zip_path) as zf:
            ...
            with tempfile.TemporaryDirectory(dir=get_bulinbot_temp_path()) as tmp_dir:
