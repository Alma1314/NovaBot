...
from bulinbot.core.pipeline.context_utils import call_event_hook
from bulinbot.core.star.star_handler import EventType


class MainAgentHooks(BaseAgentRunHooks[BulinAgentContext]):
    async def on_agent_begin(
        self, run_context: ContextWrapper[BulinAgentContext]
    ) -> None:
...
class EmptyAgentHooks(BaseAgentRunHooks[BulinAgentContext]):
    pass
