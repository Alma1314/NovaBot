...
from bulinbot.core.message.components import BaseMessageComponent, Json, Plain
...
from bulinbot.core.provider.provider import TTSProvider

AgentRunner = ToolLoopAgentRunner[BulinAgentContext]
            ...
            async for resp in agent_runner.step():
                ...
                if resp.type == "tool_call_result":
                    ...
                    if chain.type == "reasoning":
                        # For non-streaming mode, we handle reasoning in bulinbot/core/bulin_agent_hooks.py.
