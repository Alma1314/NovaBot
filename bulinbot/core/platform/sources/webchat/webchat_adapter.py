...
from bulinbot.core.db.po import PlatformMessageHistory
...
class WebChatAdapter(Platform):
    def __init__(
        ...
        self.imgs_dir = os.path.join(get_bulinbot_data_path(), "webchat", "imgs")
        self.attachments_dir = Path(get_bulinbot_data_path()) / "attachments"
    ...
    async def convert_message(self, data: tuple) -> BulinBotMessage:
