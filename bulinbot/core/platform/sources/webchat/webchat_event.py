...
from bulinbot.api.message_components import File, Image, Json, Plain, Record
from bulinbot.core.utils.bulinbot_path import get_bulinbot_data_path

from .webchat_queue_mgr import webchat_queue_mgr

attachments_dir = os.path.join(get_bulinbot_data_path(), "attachments")
...
class WebChatMessageEvent(BulinMessageEvent):
