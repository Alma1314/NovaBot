...
from bulinbot.api.message_components import File, Image, Plain, Record
from bulinbot.api.platform import (
    BulinBotMessage,
    MessageMember,
    MessageType,
    Platform,
...
from bulinbot.core.platform.bulin_message_event import MessageSesion
from bulinbot.core.utils.bulinbot_path import get_bulinbot_temp_path
from bulinbot.core.utils.media_utils import convert_audio_to_wav
from bulinbot.core.utils.webhook_utils import log_webhook_info
...
class WecomPlatformAdapter(Platform):
    ...
    async def convert_message(self, msg: BaseMessage) -> BulinBotMessage | None:
        abm = BulinBotMessage()
    ...
    async def convert_wechat_kf_message(self, msg: dict) -> BulinBotMessage | None:
        ...
        if msgtype == "text":
            ...
            temp_dir = Path(get_bulinbot_temp_path())
    ...
    async def handle_msg(self, message: BulinBotMessage) -> None:
