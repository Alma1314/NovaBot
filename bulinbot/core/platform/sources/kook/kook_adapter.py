...
from bulinbot.api.message_components import At, AtAll, Image, Plain
...
from bulinbot.core.message.components import BaseMessageComponent, File, Record, Video
...
class KookPlatformAdapter(Platform):
    ...
    async def _convert_text_message_to_component(
        ...
        # 为了解决 https://github.com/BulinBotDevs/BulinBot/issues/7539
    ...
    async def convert_message(self, data: KookMessageEventData) -> BulinBotMessage:
        abm = BulinBotMessage()
