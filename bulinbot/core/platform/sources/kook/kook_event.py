...
from bulinbot.core.platform import MessageType
...
class KookEvent(BulinMessageEvent):
    def __init__(
        self,
        message_str: str,
        ...
        self.bulinbot_message_type: MessageType = message_obj.type
