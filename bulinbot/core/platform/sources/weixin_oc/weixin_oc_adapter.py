...
from bulinbot.api.message_components import File, Image, Plain, Record, Reply, Video
...
from bulinbot.core import bulinbot_config
...
class WeixinOCAdapter(Platform):
    ...
    async def _save_account_state(self) -> None:
        ...
        for platform in bulinbot_config.get("platform", []):
    ...
    def _resolve_inbound_media_dir(self) -> Path:
        media_dir = Path(get_bulinbot_temp_path())
