...
from bulinbot.api.message_components import At, File, Json, Plain, Record, Video
from bulinbot.api.message_components import Image as BulinBotImage
...
class LarkMessageEvent(BulinMessageEvent):
    def __init__(
        self,
        message_str,
        message_obj,
    ...
    async def _convert_to_lark(message: MessageChain, lark_client: lark.Client) -> list:
        ...
        for comp in message.chain:
            ...
            elif isinstance(comp, BulinBotImage):
                file_path = ""
                image_file = None
