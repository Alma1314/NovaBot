...
from bulinbot.api.message_components import File, Image, Plain, Record, Video
...
from bulinbot.core.utils.io import download_image_by_url, file_to_base64
from bulinbot.core.utils.tencent_record_helper import wav_to_tencent_silk
...
class QQOfficialMessageEvent(BulinMessageEvent):
