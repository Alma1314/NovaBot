...
from bulinbot.api.message_components import At, File, Image, Plain, Record, Video
...
class LinePlatformAdapter(Platform):
    ...
    async def convert_message(self, event: dict[str, Any]) -> BulinBotMessage | None:
    ...
    async def handle_msg(self, abm: BulinBotMessage) -> None:
