...
from bulinbot.core.db.po import Conversation
...
from bulinbot.core.utils.trace import TraceSpan

from .bulinbot_message import BulinBotMessage, Group
from .message_session import MessageSesion, MessageSession  # noqa
from .platform_metadata import PlatformMetadata


class BulinMessageEvent(abc.ABC):
    def __init__(
        self,
        message_str: str,
        ...
        """消息对象, BulinBotMessage。带有完整的消息结构。"""
    ...
    def set_result(self, result: MessageEventResult | str) -> None:
        ...
        Example:
        ```
        async def ban_handler(self, event: BulinMessageEvent):
        ...
        async def check_count(self, event: BulinMessageEvent):
            self.count += 1
    ...
    def should_call_llm(self, call_llm: bool) -> None:
        ...
        只会阻止 BulinBot 默认的 LLM 请求链路，不会阻止插件中的 LLM 请求。
        """
