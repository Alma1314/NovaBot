...
When no Bay endpoint is configured, BulinBot can automatically start a Bay
...
BAY_CONTAINER_NAME = "bulinbot-bay"
BAY_LABEL = "bulinbot.bay.managed"
BAY_PORT = 8114
HEALTH_TIMEOUT_S = 60
...
class BayContainerManager:
    ...
    async def ensure_running(self) -> str:
        ...
        If a container labelled ``bulinbot.bay.managed`` already exists
