...
from bulinbot.core.agent.context.token_counter import EstimateTokenCounter
...
async def _parse_local_docx_text(file_bytes: bytes, file_name: str) -> str:
    from bulinbot.core.knowledge_base.parsers.markitdown_parser import (
        MarkitdownParser,
    )
...
async def _parse_local_pdf_text(file_bytes: bytes, file_name: str) -> str:
    from bulinbot.core.knowledge_base.parsers.pdf_parser import PDFParser
