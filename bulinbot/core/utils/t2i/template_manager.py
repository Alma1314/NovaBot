# bulinbot/core/utils/t2i/template_manager.py
...
from bulinbot.core.utils.bulinbot_path import get_bulinbot_data_path, get_bulinbot_path
...
class TemplateManager:
    ...
    CORE_TEMPLATES = [
        "base.html",
        "bulinbot_powershell.html",
        "bulinbot_vitepress.html",
    ]
    ...
    def __init__(self) -> None:
        ...
        self.user_template_dir = os.path.join(get_bulinbot_data_path(), "t2i_templates")
