from bulinbot.core.log import LogManager
...
class HtmlRenderer:
    ...
    async def render_custom_template(
        ...
        @example: 参见 https://docs.bulinbot.app 插件开发部分。
        """
    ...
    async def render_t2i(
        ...
        if use_network:
            try:
                ...
                logger.error(
                    f"Failed to render image via BulinBot API: {e}. Falling back to local rendering.",
                )
