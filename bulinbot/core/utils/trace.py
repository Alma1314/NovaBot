...
from bulinbot.core import LogManager, bulinbot_config
from bulinbot.core.log import LogQueueHandler
...
def _get_trace_logger():
    ...
    _trace_logger = logging.getLogger("bulinbot.trace")
    return _trace_logger
...
class TraceSpan:
    ...
    def record(self, action: str, **fields: Any) -> None:
        ...
        if not bulinbot_config.get("trace_enable", True):
            return
