...
class StorageCleaner:
    ...
    def __init__(
        ...
        *,
        ...
        self._config = config
        self._data_dir = data_dir or Path(get_bulinbot_data_path())
        self._temp_dir = temp_dir or Path(get_bulinbot_temp_path())
        ...
        return [
            LogFileConfig(
                path=self._resolve_log_path(
                    ...
                    default_relative_path="logs/bulinbot.log",
                ),
            ...
            LogFileConfig(
                path=self._resolve_log_path(
                    ...
                    default_relative_path="logs/bulinbot.trace.log",
                ),
