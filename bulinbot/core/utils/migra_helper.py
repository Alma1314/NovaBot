...
from bulinbot.core.bulinbot_config_mgr import BulinBotConfig, BulinBotConfigManager
from bulinbot.core.db.migration.migra_45_to_46 import migrate_45_to_46
from bulinbot.core.db.migration.migra_token_usage import migrate_token_usage
from bulinbot.core.db.migration.migra_webchat_session import migrate_webchat_session


def _migra_agent_runner_configs(conf: BulinBotConfig, ids_map: dict) -> None:
    """
...
def _migra_provider_to_source_structure(conf: BulinBotConfig) -> None:
    """
...
async def migra(
    db, bulinbot_config_mgr, umop_config_router, acm: BulinBotConfigManager
) -> None:
    """
    ...
    try:
        await migrate_45_to_46(bulinbot_config_mgr, umop_config_router)
    except Exception as e:
    ...
    try:
        _migra_provider_to_source_structure(bulinbot_config)
    except Exception as e:
