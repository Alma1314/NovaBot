...
from bulinbot.api.provider import Provider
...
from bulinbot.core.provider.entities import LLMResponse, TokenUsage, ToolCallsResult
from bulinbot.core.utils.bulinbot_path import get_bulinbot_temp_path
from bulinbot.core.utils.io import download_file, download_image_by_url
from bulinbot.core.utils.media_utils import ensure_wav
from bulinbot.core.utils.network_utils import (
    create_proxy_client,
    is_connection_error,
...
class ProviderOpenAIOfficial(Provider):
    ...
    async def _query_stream(
        ...
        async for chunk in stream:
            ...
            # refs: BulinBot#6689 / openai-python#5069 / #5047
            ...
            if chunk.usage:
                ...
                # See https://github.com/BulinBotDevs/BulinBot/issues/6614
    ...
    async def _parse_openai_completion(
        ...
        if choice.finish_reason == "content_filter":
            raise Exception(
                "API 返回的 completion 由于内容安全过滤被拒绝(非 BulinBot)。",
            )
