...
from bulinbot.core import bulinbot_config, logger, sp
from bulinbot.core.bulinbot_config_mgr import BulinBotConfigManager
from bulinbot.core.db import BaseDatabase
from bulinbot.core.utils.error_redaction import safe_error
...
class ProviderManager:
    ...
    async def reload(self, provider_config: dict) -> None:
        async with self.reload_lock:
            ...
            # 和配置文件保持同步
            self.providers_config = bulinbot_config["provider"]
            self.provider_sources_config = bulinbot_config.get("provider_sources", [])
