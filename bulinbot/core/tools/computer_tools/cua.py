...
async def _get_gui_component(context: ContextWrapper[BulinAgentContext]) -> Any:
...
class CuaScreenshotTool(FunctionTool):
    name: str = "bulinbot_cua_screenshot"
    description: str = (
...
class CuaMouseClickTool(FunctionTool):
    name: str = "bulinbot_cua_mouse_click"
...
class CuaKeyboardTypeTool(FunctionTool):
    name: str = "bulinbot_cua_keyboard_type"
...
def _new_screenshot_path(umo: str) -> str:
    ...
    screenshot_dir = Path(get_bulinbot_temp_path()) / "cua_screenshots"
