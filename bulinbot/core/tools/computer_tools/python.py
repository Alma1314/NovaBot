...
from bulinbot.core.bulin_agent_context import BulinAgentContext, BulinMessageEvent
from bulinbot.core.computer.computer_client import get_booter, get_local_booter
...
async def handle_result(result: dict, event: BulinMessageEvent) -> ToolExecResult:
...
class PythonTool(FunctionTool):
    name: str = "bulinbot_execute_ipython"
...
class LocalPythonTool(FunctionTool):
    name: str = "bulinbot_execute_python"
    description: str = (
