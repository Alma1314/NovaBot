...
from bulinbot.core.skills.neo_skill_sync import NeoSkillSyncManager
from bulinbot.core.tools.computer_tools.util import check_admin_permission
...
class GetExecutionHistoryTool(NeoSkillToolBase):
    name: str = "bulinbot_get_execution_history"
...
class AnnotateExecutionTool(NeoSkillToolBase):
    name: str = "bulinbot_annotate_execution"
...
class CreateSkillPayloadTool(NeoSkillToolBase):
    name: str = "bulinbot_create_skill_payload"
    description: str = (
...
class GetSkillPayloadTool(NeoSkillToolBase):
    name: str = "bulinbot_get_skill_payload"
...
class CreateSkillCandidateTool(NeoSkillToolBase):
    name: str = "bulinbot_create_skill_candidate"
    description: str = (
    ...
    parameters: dict = field(
        default_factory=lambda: {
            ...
            "properties": {
                ...
                "payload_ref": {
                    "type": "string",
                    "description": "Optional payload reference created by bulinbot_create_skill_payload.",
                },
            },
...
class ListSkillCandidatesTool(NeoSkillToolBase):
    name: str = "bulinbot_list_skill_candidates"
...
class EvaluateSkillCandidateTool(NeoSkillToolBase):
    name: str = "bulinbot_evaluate_skill_candidate"
...
class PromoteSkillCandidateTool(NeoSkillToolBase):
    name: str = "bulinbot_promote_skill_candidate"
    description: str = (
...
class ListSkillReleasesTool(NeoSkillToolBase):
    name: str = "bulinbot_list_skill_releases"
...
class RollbackSkillReleaseTool(NeoSkillToolBase):
    name: str = "bulinbot_rollback_skill_release"
...
class SyncSkillReleaseTool(NeoSkillToolBase):
    name: str = "bulinbot_sync_skill_release"
    description: str = (
