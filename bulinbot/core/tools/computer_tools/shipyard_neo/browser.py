...
async def _get_browser_component(context: ContextWrapper[BulinAgentContext]) -> Any:
...
class BrowserExecTool(FunctionTool):
    name: str = "bulinbot_execute_browser"
...
class BrowserBatchExecTool(FunctionTool):
    name: str = "bulinbot_execute_browser_batch"
...
class RunBrowserSkillTool(FunctionTool):
    name: str = "bulinbot_run_browser_skill"
