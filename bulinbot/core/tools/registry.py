...
_BUILTIN_TOOL_MODULES = (
    "bulinbot.core.tools.computer_tools",
    "bulinbot.core.tools.cron_tools",
    "bulinbot.core.tools.knowledge_base_tools",
    "bulinbot.core.tools.message_tools",
    "bulinbot.core.tools.web_search_tools",
)
