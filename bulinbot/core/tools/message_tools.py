...
@builtin_tool
@dataclass
class SendMessageToUserTool(FunctionTool[BulinAgentContext]):
        ...
        *,
        ...
        if not os.path.isabs(path):
            ...
            if unified_msg_origin:
                from bulinbot.core.tools.computer_tools.util import workspace_root
    ...
    async def call(
        ...
        # Security: only BulinBot admins can send messages to other sessions.
        # Non-admin users are always restricted to their own session.
        # See https://github.com/BulinBotDevs/BulinBot/issues/7822
        ...
        try:
            ...
            # issue: https://github.com/BulinBotDevs/BulinBot/issues/7907
