...
from bulinbot.core.db.po import Persona, PersonaFolder, Personality
from bulinbot.core.platform.message_session import MessageSession
from bulinbot.core.sentinels import NOT_GIVEN
...
class PersonaManager:
    def __init__(self, db_helper: BaseDatabase, acm: BulinBotConfigManager) -> None:
        self.db = db_helper
        self.acm = acm
    ...
    def get_v3_persona_data(
        ...
        """获取 BulinBot <4.0.0 版本的 persona 数据。
