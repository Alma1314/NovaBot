...
from bulinbot.api import sp, star
from bulinbot.api.event import BulinMessageEvent, MessageEventResult
...
from bulinbot.core.agent.runners.deerflow.deerflow_api_client import DeerFlowAPIClient
...
class ConversationCommands:
    ...
    async def reset(self, message: BulinMessageEvent) -> None:
        ...
        plugin_config = alter_cmd_cfg.get("bulinbot", {})
