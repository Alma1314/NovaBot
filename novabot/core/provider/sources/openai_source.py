...
from novabot.api.provider import Provider
...
from novabot.core.agent.tool import ToolSet
...
from novabot.core.provider.entities import LLMResponse, TokenUsage, ToolCallsResult
from novabot.core.utils.novabot_path import get_novabot_temp_path
from novabot.core.utils.io import download_file, download_image_by_url
from novabot.core.utils.media_utils import ensure_wav
from novabot.core.utils.network_utils import (
    create_proxy_client,
    is_connection_error,
    log_connection_failure,
)
from novabot.core.utils.string_utils import normalize_and_dedupe_strings
...
class ProviderOpenAIOfficial(Provider):
    ...
    async def _audio_ref_to_local_path(self, audio_ref: str) -> tuple[str, list[Path]]:
        ...
        if audio_ref.startswith("http"):
            ...
            temp_dir = Path(get_novabot_temp_path())
    ...
    async def _query_stream(
        ...
        async for chunk in stream:
            ...
            # refs: NovaBot#6689 / openai-python#5069 / #5047
    ...
    async def _parse_openai_completion(
        ...
        if choice.finish_reason == "content_filter":
            raise Exception(
                "API 返回的 completion 由于内容安全过滤被拒绝(非 NovaBot)。",
            )
