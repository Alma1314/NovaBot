...
from novabot.api.message_components import At, AtAll, Image, Plain
...
from novabot.core.message.components import BaseMessageComponent, File, Record, Video
...
class KookPlatformAdapter(Platform):
    ...
    async def convert_message(self, data: KookMessageEventData) -> NovaBotMessage:
        abm = NovaBotMessage()
