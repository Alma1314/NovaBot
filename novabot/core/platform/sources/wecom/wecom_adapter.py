...
from novabot.api.message_components import File, Image, Plain, Record
...
from novabot.core.utils.media_utils import convert_audio_to_wav
from novabot.core.utils.webhook_utils import log_webhook_info
...
class WecomPlatformAdapter(Platform):
    ...
    async def convert_message(self, msg: BaseMessage) -> NovaBotMessage | None:
        abm = NovaBotMessage()
        if isinstance(msg, TextMessage):
            ...
            temp_dir = get_novabot_temp_path()
    ...
    async def convert_wechat_kf_message(self, msg: dict) -> NovaBotMessage | None:
    ...
    async def handle_msg(self, message: NovaBotMessage) -> None:
